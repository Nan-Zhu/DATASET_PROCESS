...
def test_set_sampling(data_set, test_size, random_state):
    '''
    ...
    test_data.to_csv('../dataset/INTERACTION/prediction_test/test_data_sampled.csv', index=False)
    print('test_data sampled: size', test_data.shape)
...
if __name__ == '__main__':
    ...
    test_set_sampling(split_data_set, 0.2, 0)
